...
import { Call3, Hangup, Keyboard } from 'components/Icons';
  ...
  const pushMessage = (message: any) => {
    ...
    if (isSameRole && streamMessageRef.current) {
      ...
      if (transcriptType === 'partial') {
        ...
        setStreamLoading(false);
        const finalContent =
          (streamMessageRef.current.final || '') + transcript + ' ';
          ...
          ...messagesListRef.current,
          {
            ...
            content: processTextReplacements(
              streamMessageRef.current.final ||
                streamMessageRef.current.content,
            ),
          },
        ];
      }
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.footer}>
        ...
        {callStatus === 'start' && (
          <div
            className={cx(styles.callingBtn, styles.chatBtn)}
            onClick={onSwitch}
          >
            <div className={styles.callingBtnCon}>
