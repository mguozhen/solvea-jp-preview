...
export const metadata = {
  title: 'Terms & Condition | Solvea',
  description: 'Solvea Terms & Condition',
  alternates: generateHrefLangConfig('/terms-and-condition', undefined, SITE_WITH_PORTAL),
};
  ...
  return (
    <>
      ...
      <div className={styles.content}>
        ...
        <p>Updated at 2024-06-11</p>
        <h2>General Terms</h2>
        <p>
          By accessing and placing an order with Solvea.cx(The website:
          {BASE_HOST}, Solvea.cx abbreviation below as Solvea), you confirm that
        ...
        <p>
          Under no circumstances shall Solvea team be liable for any direct,
          ...
          inability to use, the materials on this site, even if Solvea team or
        ...
        <p>
          Solvea will not be responsible for any outcome that may occur during
        ...
        <h2>License</h2>
        <p>
          Solvea grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website/app strictly
          in accordance with the terms of this Agreement.
        </p>
        <p>
          These Terms & Conditions are a contract between you and Solvea
          (referred to in these Terms & Conditions as "Solvea", "us", "we" or
          "our"), the provider of the Solvea website and the services accessible
          from the Solvea website (which are collectively referred to in these
          Terms & Conditions as the "Solvea Service").
        </p>
        <p>
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the Solvea
        ...
        <p>
          ...
          “us,” or “our,” it refers to Solvea LIMITED, 160 E Tasman Drive Suite
          202 San Jose, CA, 95134. that is responsible for your information
          under this Terms & Conditions. Country: where Solvea or the
          owners/founders of Solvea are based, in this case is US. Device: any
          internet connected device such as a phone, tablet, computer or any
          other device that can be used to visitSolvea and use the services.
          Service: refers to the service provided by Solvea as described in the
          ...
          products or services we think may interest you. Website: Solvea."'s"
          site, which can be accessed via this URL: solvea.cx You: a person or
          entity that is registered with Solvea to use the Services.
        </p>
        <h2>Restrictions</h2>
        ...
        <p>
          ...
          or make the platform available to any third party. Modify, make
          derivative works of, disassemble, decrypt, reverse compile or reverse
          Remove, alter or obscure any proprietary notice (including any notice
          of copyright or trademark) of Solvea or its affiliates, partners,
          suppliers or the licensors of the website/app.
        </p>
        <h2>Payments</h2>
        <p>
          You agree to pay Company any applicable fees posted for the Services
          selected. By completing and submitting any credit card or other
          payment authorization through the Services, you are authorizing
          Company to charge the fees to the account you identify. You authorize
          and direct us to retain information about the payment method(s)
          associated with your account.
        </p>
        <p>
          Your are entitled to a full refund if you elect to terminate the
          Services within the first seven (7) days of your initial purchase.
          ...
          credits or refunds for partially used periods or periods of non-usage.
          Following any cancellation by you, however, you will continue to have
          access to the paid Services through the end of the subscription period
          for which payment has already been made.
        </p>
        <p>
          Any refunds of funds after termination is at the sole discretion of
          the Company. You must keep all contact and billing information,
          including payment method, up-to-date. If we do not receive payment
        ...
        <p>
          ...
          you or anyone you allow to use your account, or anyone who gains
          access to your account as a result of your failure to safeguard your
          username, password, or other authentication credentials or
          information.
        </p>
        <p>
          Thanks for shopping at Solvea. We appreciate the fact that you like to
        ...
        <p>
          ...
          apply to transactions at Solvea. We'll be as brief as our attorneys
          will allow. The main thing to remember is that by placing an order or
          making a purchase at Solvea, you agree to the terms along with
          Solvea's Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          (collectively, "Suggestions") provided by you to Solvea with respect
          to the website/app shall remain the sole and exclusive property of
          Solvea.
        </p>
        <p>
          Solvea shall be free to use, copy, modify, publish, or redistribute
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Solvea.
        ...
        <h2>Cookies</h2>
        <p>
          Solvea uses "Cookies" to identify the areas of our website that you
        ...
        <p>
          You acknowledge and agree that Solvea may stop (permanently or
          temporarily) providing the Service (or any features within the
          Service) to you or to users generally at Solvea's sole discretion,
          without prior notice to you. You may stop using the Service at any
          time. You do not need to specifically inform Solvea when you stop
          using the Service. You acknowledge and agree that if Solvea disables
        ...
        <p>
          Solvea reserves the right to modify, suspend or discontinue,
        ...
        <p>
          Solvea may from time to time provide enhancements or improvements to
        ...
        <p>
          ...
          of the website/app. You agree that Solvea has no obligation to (i)
        ...
        <p>
          ...
          <br />
          You acknowledge and agree that Solvea shall not be responsible for any
          ...
          or any other aspect thereof. Solvea does not assume and shall not have
        ...
        <p>
          Solvea may, in its sole discretion, at any time and for any or no
        ...
        <p>
          ...
          Solvea, in the event that you fail to comply with any provision of
        ...
        <p>
          Termination of this Agreement will not limit any of Solvea's rights or
          remedies at law or in equity in case of breach by you (during the term
          of this Agreement) of any of your obliga
        </p>
        ...
        <p>
          You agree to indemnify and hold Solvea and its parents, subsidiaries,
        ...
        <p>
          ...
          extent permitted under applicable law, Solvea, on its own behalf and
          ...
          fitness for a particular purpose, title andnon-infringement, and
          warranties that may arise out of course of dealing, course of
          performance, usage or trade practice.
          <br />
          Without limitation to the foregoing, Solvea provides no warranty or
          undertaking, and makes no representation of any kind that the
          website/app will meet your requirements, achieve any intended results,
        ...
        <p>
          Without limiting the foregoing, neither Solvea nor any Solvea's
          provider makes any representation or warranty of any kind, express or
          implied: (i) as to the operation or availability of the website/app,
          or the information, content, and materials or products included
          thereon; (ii) that the website/app will be uninterrupted or
          error-free; (iii) as to the accuracy, reliability, or currency of any
          information or content provided through the website/app; or (iv) that
          the website/app, its servers, the content, or e-mails sent from or on
          behalf of Solvea are free of viruses, scripts, trojan horses, worms,
        ...
        <p>
          ...
          limitations set out above may not apply to you.
        </p>
        <h2>Limitation of Liability</h2>
        <p>
          Notwithstanding any damages that you might incur, the entire liability
          of Solvea and any of its suppliers under any provision of this
        ...
        <p>
          ...
          Solvea or its suppliers be liable for any special, incidental,
          ...
          connection with any provision of this Agreement), even if Solvea or
        ...
        <p>
          ...
          notices published by Solvea on the Services, shall constitute the
          entire agreement between you and Solvea concerning the Services. If
          ...
          term or any other term, and Solvea."'s" failure to assert any right or
          provision under this Agreement shall not constitute a waiver of such
          right or provision. YOU AND Solvea AGREE THAT ANY CAUSE OF ACTION
        ...
        <p>
          Solvea reserves the right, at its sole discretion, to modify or
        ...
        <p>
          The Agreement constitutes the entire agreement between you and Solvea
          regarding your use of the website/app and supersedes all prior and
          contemporaneous written or oral agreements between you and Solvea.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other Solvea's services, which Solvea will provide
        ...
        <p>
          ...
          Terms, you can stop using our Service at any time.
        </p>
        ...
        <p>
          ...
          arrangement thereof), are owned by Solvea, its licensors or other
          providers of such material and are protected by Hong Kong and
          ...
          Solvea, unless and except as is expressly provided in these Terms &
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Solvea's
          INTELLECTUALPROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and Solvea concerning the
        ...
        <p>
          In the event of a dispute, you or Solvea must give the other a Notice
          ...
          any Notice of Dispute via email to: support@solvea.cx. Solvea will
          send any Notice of Dispute to you by mail to your address if we have
          it, or otherwise to your email address. You and Solvea will attempt to
          ...
          days, you or Solvea may commence arbitration.
        </p>
        <h2>Binding Arbitration</h2>
        <p>
          If you and Solvea don't resolve any dispute by informal negotiation,
        ...
        <p>
          ...
          and will become the sole property of Solvea without any compensation
          or credit to you whatsoever. Solvea and its affiliates shall have no
        ...
        <h2>Promotions</h2>
        <p>
          Solvea may, from time to time, include contests, promotions,
        ...
        <p>
          ...
          representative of Solvea. Solvea will be entitled to injunctive or
          ...
          Solvea operates and controls the Solvea Service from its offices in
          Hong Kong. The Service is not intended for distribution to or use by
          any person or entity in any jurisdiction or country where such
          distribution or use would be contrary to law or regulation.
          Accordingly, those persons who choose to access the Solvea Service
          ...
          incorporate the Solvea Privacy Policy) contains the entire
          understanding, and supersedes all prior understandings, between you
          and Solvea concerning its subject matter, and cannot be changed or
        ...
        <h2>Disclaimer</h2>
        <p>
          Solvea is not responsible for any content, code or any other
          imprecision. Solvea does not provide warranties or guarantees.In no
          event shall Solvea be liable for any special, direct, indirect,
        ...
        <p>
          The Solvea Service and its contents are provided "as is" and "as
          available" without any warranty or representations of any kind,
          whether express or implied. Solvea is a distributor and not a
          publisher of the content supplied by third parties; as such, Solvea
          ...
          accessible via the Solvea Service. Without limiting the foregoing,
          Solvea specifically disclaims all warranties and representations in
          any content transmitted on or in connection with the Solvea Service or
          on sites that may appear as links on the Solvea Service, or in the
          products provided as a part of, or otherwise in connection with, the
          Solvea Service, including without limitation any warranties of
          merchantability, fitness for a particular purpose or non-infringement
          of third party rights. No oral advice or written information given by
          Solvea or any of its affiliates, employees, officers, directors,
          ...
          foregoing, Solvea does not warrant that the Solvea Service will be
